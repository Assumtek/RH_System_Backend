...
interface CountTimeRequest {
  userId: string;
  contract: string; // "CLT" ou "PJ"
}

// Serviço para criar registro de ponto
export const createAttendanceService = async ({ userId, type }: CreateAttendanceRequest) => {
...
// Serviço para contar tempo de trabalho
export const countTimeService = async ({ userId, contract }: CountTimeRequest) => {
